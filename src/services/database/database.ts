...
import { parseDbPath, embedParams, rowToGame, gameToRow, extractValue } from '../database/database-helpers';
...
} from '../database/database-pipeline';
import {
...
} from '../database/database-collections';
import type { Collection } from '../database/database-collections';

export type { LogEntry, LogFilter } from '../database/database-types';
...
export class DatabaseService implements IDatabaseService {
  ...
  async getPipelineLogs(filter?: import('../database/database-types').LogFilter): Promise<import('../database/database-types').LogEntry[]> {
